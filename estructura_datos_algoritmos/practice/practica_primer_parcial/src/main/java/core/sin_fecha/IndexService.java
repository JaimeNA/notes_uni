...
public interface IndexService {
    ...
    // Devuelve un array con todas las claves que se encuentren en el intervalo [leftKey, rightKey).
    // Es decir, las claves mayores o iguales a leftKey y las estrictamente menores a rightKey.
