...
//	    indexPolucion = new IndexWithDuplicates<>(IdxRecord.class);
	...
	public static float average(HashMap<Long, CSVRecord>  data, IndexParametricService<IdxRecord<Double, Long>> indexPolucion) {
		int toReturn = 0;
		// for(IdxRecord<Double, Long> pol : indexPolucion) {
