...
public class ExpTreeVars implements ExpressionService {
	...
	public ExpTreeVars(HashMap<String, Double> variables) {
	    System.out.print("Introduzca la expresi�n en notaci�n infija con todos los par�ntesis y blancos: ");
	...
	static final class Node {
        ...
        private Node buildExpression() {
            ...
            if (!(Utils.isConstant(toReturn.data) || variables.containsKey(toReturn.data)))
	...
	public static void main(String[] args) {
		...
		ExpressionService myExp = new ExpTreeVars(vars);
